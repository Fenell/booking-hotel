...
export const AG_GRID_LOCALE_VN = {
  ...
  advancedFilterValidationJoinOperatorMismatch:
    "Các toán tử kết nối trong một điều kiện phải giống nhau",
  ...
  advancedFilterValidationMessage:
    "Biểu thức có lỗi. ${variable} - ${variable}.",
  ...
  advancedFilterBuilderValidationIncomplete:
    "Không phải tất cả điều kiện đều đã hoàn thành.",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. Mức ${variable}. Nhấn ENTER để chỉnh sửa.",
  ariaAdvancedFilterBuilderItemValidation:
    "${variable}. Mức ${variable}. ${variable} Nhấn ENTER để chỉnh sửa.",
  ...
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "Bộ lọc nâng cao - Chọn tùy chọn",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "Bộ lọc nâng cao - Chọn toán tử nối",
